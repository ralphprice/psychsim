...
TRUTH for substrate structure and parameters (Part 2 S1.3; Part 3 S3): 96 circuits (nucleus-
level rate units), 206 directed inter-circuit edges (the seed carries 241 connection entries;
the extra are sensory input-channel edges, excluded from model.connections) -- grown from the
original 83/212 by the DRN/cortical-interneuron, OT-kinship, and dev-social passes, always
additively. Plus a 25-entry innate-wiring catalogue, 9 input channels
